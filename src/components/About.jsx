...
function About() {
  return (
    <div>
      <nav className="grid grid-cols-3 w-80 ml-auto text-orange-600 text-xl font-semibold pb-10">
        <Link to="/">Home</Link>
        <Link to="/Service">Service</Link>
        <Link to="/About">About</Link>
      </nav>
      <div className="grid grid-cols-1 md:grid-cols-2 ">
        <p className="flex justify-center m-16 text-lg font-semibold ">
        ...
        <img
          ...
          className="rounded-xl h-96 md:ml-10 md:mt-28 lg:mt-10 md:mr-10 "
        />
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-14">
        <span className="flex flex-col ">
          <img
            ...
            alt="ceo photo"
            className="rounded-full h-48 md:h-52 w-48 md:w-56 md:ml-16 ml-20"
          />
          <div className="pt-5 ">
          <p className="text-xl font-semibold ">Adam Khalil</p>
        ...
        <span>
          ...
          />
          <div className="pt-5 ">
          <p className="text-xl font-semibold">Lina Saeed</p>
        ...
        <span>
          ...
          />
          <div className="pt-5  ">
          <p className="text-xl font-semibold"> Omar Hassan</p>
